...
export const gallery: GalleryItem[] = [
  ...
  { slug: "ac-mirage", name: "Assassin's Creed Mirage", studio: "Ubisoft", detail: "Action · PS5, Xbox Series, PC" },
  ...
  { slug: "ac-black-flag-remake", name: "Assassin's Creed IV: Black Flag Remake", studio: "Ubisoft", detail: "Action · PS5, Xbox Series, PC" },
